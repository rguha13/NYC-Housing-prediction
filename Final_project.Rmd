...
# latex_table4 <- xtable(head(data_filtered[,c("SUBLOCALITY", "SUBLOCALITY_encoded")]))
# print(latex_table4, include.rownames = FALSE)
```

Selecting the features (X) and the target (Y)
```{r}
data_filtered_rf <- data_filtered[,c("BEDS", "BATH", "PROPERTYSQFT", "log_PRICE", "SUBLOCALITY_encoded")]
X <- data_filtered_rf[, c("BEDS", "BATH", "PROPERTYSQFT", "SUBLOCALITY_encoded")]
...
# Visualize feature importance
 # png(filename="C:/Users/riana/OneDrive/Desktop/Spring 2024/STAT 692/fig13.png")
barplot(sorted_feature_importance[, 1], names.arg = rownames(sorted_feature_importance),
